...
@Component({
  selector: 'app-addnylon',
  templateUrl: './addnylon.component.html',
  styleUrls: ['./addnylon.component.css']
})
export class AddnylonComponent implements OnInit {
  ...
  toggleCreatedobInput(): void {
    ...
    this.showdobInput = !this.showdobInput;
  }
...
sortdobsAlphabetically(): void {
  ...
  editdob(dob: dob): void {
    ...
    const newName = prompt('Enter the new folder name:', dob.name);
