...
@Component({
  ...
  styleUrls: ['./finition.component.css']
})
export class FinitionComponent   implements OnInit {
  doms: dom[] = [];
...
onPageChange(pageNumber: number): void {
  ...
  slogan: string = "La touche finale qui fait toute la différence. Notre équipe Finition incarne la précision pour des résultats impeccables.";
...
translateToEnglish(): void {
    ...
    this.slogan = "The finishing touch that makes all the difference. Our Finishing team embodies precision for flawless results.";
